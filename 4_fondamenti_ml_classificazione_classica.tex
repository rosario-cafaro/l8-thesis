...
\begin{itemize}
    ...
    \item $\gamma \in [0, 1)$ rappresenta il fattore di sconto (\textit{discount factor}), che determina l'importanza geometricamente decrescente delle ricompense future rispetto a quelle immediate.
\end{itemize}
