...
Per rendere confrontabili i modelli classici e quantistici, è stato definito un protocollo sperimentale comune (stessi dati in ingresso e stesse metriche di valutazione), applicato in modo identico a tutte le configurazioni testate. Il protocollo non prevede invece lo stesso sforzo di ottimizzazione degli iperparametri per le due famiglie di modelli, aspetto di cui si tiene conto nella formulazione delle conclusioni (Sezione~\ref{sec:limiti_studio}).
