...
\begin{itemize}
    ...
    \item \textbf{Scelta degli iperparametri quantistici}: la configurazione di feature map e ansatz (Sezione~\ref{sec:configurazione_sperimentale}) rappresenta una tra le molte possibili. Risultati diversi potrebbero essere ottenuti con strutture di circuito alternative, non esplorate sistematicamente in questo lavoro per ragioni di tempo e di risorse computazionali disponibili.
\end{itemize}
